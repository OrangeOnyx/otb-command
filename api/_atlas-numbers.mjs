/* Private, immutable publication of a dated production-ledger extract. This module never
...
const fail = () => { throw new Error('Ledger extract is invalid or unavailable.'); };
