...
Figures from the reconciled rent-roll source of truth as of ${esc(m.generated)}; scheduled billings include recoveries. Occupancy is SF-weighted on demised area (${esc(m.totalSf.toLocaleString())} SF; audited headline GLA 62,883 SF). Generated by Cypress Command — deterministic, no estimated figures.</div>
</div></body></html>`;
}
