...
${kpiTile(m.occupiedSf.toLocaleString() + " SF", `of ${m.totalSf.toLocaleString()} SF occupied`)}
</div>
...
Figures from the reconciled rent-roll source of truth as of ${esc(m.generated)}; scheduled billings include recoveries. Generated by OTB Property Command — deterministic, no estimated figures.</div>
</div></body></html>`;
}
