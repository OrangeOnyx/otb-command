...
<p class="legal">Prepared ${esc(today)} by Cypress Command Platform (AI-1 leasing agent) from operator-confirmed terms. Mirrors the Owner Lease Summary Form — verify against the executed lease before filing.</p>
