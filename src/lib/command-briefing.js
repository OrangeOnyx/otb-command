...
<style>
  ...
  *{box-sizing:border-box}html{font-size:16px}body{margin:0;color:var(--charcoal);background:var(--bone);font-family:Inter,"Segoe UI",Arial,sans-serif;line-height:1.55}
  ...
  <header class="masthead">${logo ? `<img class="brand-logo" src="${logo}" alt="Cypress Command">` : '<span class="brand-name">Prepared with Cypress Command Platform</span>'}<div class="packet-label">Owner briefing<br>On The Boulevard</div></header>
  ...
  <footer class="foot">Cypress Command Platform · Owner review copy · Record excerpts retain their own dates. This offline document contains no sending or business-record controls. Use the browser’s Print command to print or save a PDF.</footer>
