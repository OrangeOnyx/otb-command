...
**2026-09-06 — REV 14: Arnould frontage "skinny islands" added** (operator: "we have some skinny islands along Arnould that do not appear"). CAD LINCONC confirms them: 3.1' planting strip behind the sidewalk along the three eastern head-in modules, four 3–4' × 17' curbed end caps (E of Driveway A, between 11|11, between 11|9, W of Driveway B), a 9' strip + 4' nose at the 7-space module, landscape across the whole 149 frontage from the 5' walk. Stalls pulled back to CAD depth (18', b −3.6…−21.6; 7-space module b −9.4…−27.4) — REV 12–13 ran them to the property line. Extractor + test/site-access.test.mjs updated; inventory memo has a REV 14 section. Same PR #1. ChatGPT render the operator mentioned was NOT attached — not evaluated.
