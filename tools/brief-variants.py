...
VARIANTS = {
    "belle": {
        "title": "Cypress Command — Owner Edition · Belle Realty of Lafayette",
...
""",
    ...
    "partner": {
        "title": "Cypress Command — Design-Partner Edition",
        "tag": '<div class="tag">Prepared for prospective design-partner owners · July 2026</div>',
        "onesent": (
            '<div class="onesent">Cypress Command — proven end-to-end on '
